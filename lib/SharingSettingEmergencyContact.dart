...
class SharingSettingEmergencyContact extends StatefulWidget {
...
class _EmergencyScreenState extends State<SharingSettingEmergencyContact> {
                            ...
                            children: List.generate(kinContact.length, (index) {
                              ...
                              return ListTile(
                                ...
                                leading: Container(
                                  ...
                                  child:CircleAvatar(
                                    child: Text(
                                        (kinContact[index].name.substring(0,1).toUpperCase()),
                          ...
                          children: List.generate(collegueContact.length, (index) {
                            ...
                            return ListTile(
                              ...
                              leading: Container(
                                ...
                                child:CircleAvatar(
                                  child: Text(
                                      (collegueContact[index].name.substring(0,1).toUpperCase()),
                                      style: TextStyle(color: Colors.white)),
                                ),
                              ),
  ...
  Future<http.Response> getEmergencyContact(
