...
import 'package:kinga/Data/BikeDetailResponse.dart';
...
class _BikeDetailState extends State<BikeDetail> {
                                    ...
                                    children: [
                                                      ...
                                                      : InkWell(
                                                          child: Container(
                                                              ...
                                                              decoration: new BoxDecoration(
                                                                  ...
                                                                  image: new DecorationImage(fit: BoxFit.fill, image: NetworkImage(networkImage)))),
                                                          onTap: () {
                                                            assignedVal();
                                                            isBikeDetail = true;
                                                            Navigator.push(
                                      ...
                                      InkWell(
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              selectedYear == "Select Year" ? "Select Year" : selectedYear,
                                              style: selectedYear == null ? placeholderStyle : selectedValueStyle,
                                            ),
                                            IconButton(
                                      ...
                                      Padding(
                                        ...
                                        child: DropdownButton(
                                          ...
                                          iconSize: 25,
                                          style: selectedModel == null ? placeholderStyle : selectedValueStyle,
                                          value: selectedModel,
                                          hint: Text(
                                            "Model",
  ...
  void checkvalidation() {
    ...
    } else if (selectedYear == "Select Year" || selectedYear.isEmpty) {
      showDialog(
          context: context,
          builder: (BuildContext context1) => OKDialogBox(
  ...
  Future getData() async {
    ...
    if (widget.isUpdate == true) {
      if (uploadedImage == null) {
        map = {"user_id": user_id, "number_plate": numberTF.text, "year": selectedYear, "model": selectedModel, "color": colorTF.text, "bike_photo": ""};
      } else {
        ...
        map = {"user_id": user_id, "number_plate": numberTF.text, "year": selectedYear, "model": selectedModel, "color": colorTF.text, "bike_photo": profileImageBase64};
      }
    } else {
      List<int> imageBytes = uploadedImage.readAsBytesSync();
      print(imageBytes);
      ...
      map = {"user_id": user_id, "number_plate": numberTF.text, "year": selectedYear, "model": selectedModel, "color": colorTF.text, "bike_photo": base64ImageTemp};
    }
                      ...
                      child: Container(
                        ...
                        child: YearPicker(
                          ...
                          onChanged: (val) {
                            ...
                            print("formated date" + formatted); // something like 2013-04-20
                            setState(() {
  ...
  Future<http.Response> getModelList(String url, BuildContext context) async {
    var responseInternet;
    try {
  ...
  Future<http.Response> getBikeDetail(String url, Map jsonMap, BuildContext context) async {
    var body = json.encode(jsonMap);
    var responseInternet;
    try {
      responseInternet = await http.post(Uri.parse(url), headers: {"Content-Type": "application/json"}, body: body).then((http.Response response) {
