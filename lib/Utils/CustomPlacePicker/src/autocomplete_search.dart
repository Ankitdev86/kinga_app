...
import 'package:kinga_app/Utils/CustomPlacePicker/google_maps_place_picker.dart';
import 'package:kinga_app/Utils/CustomPlacePicker/providers/place_provider.dart';
import 'package:kinga_app/Utils/CustomPlacePicker/providers/search_provider.dart';
...
class AutoCompleteSearchState extends State<AutoCompleteSearch> {
  ...
  _onSearchInputChange() {
    ...
    if (provider.debounceTimer?.isActive !=null) {
      provider.debounceTimer.cancel();
    }
